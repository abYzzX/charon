...
public static class Check
{
    ...
    public static short Range(short value, string parameterName, short minimumValue,
    ...
    public static float Range(float value, string parameterName, float minimumValue,
    ...
    public static double Range(double value, string parameterName, double minimumValue,
    ...
    public static decimal Range(decimal value, string parameterName, decimal minimumValue,

...
public static unsafe partial class SdlGpu
{
	...
	public struct SDL_GPUColorTargetInfo
	{
		...
		public uint mip_level;
		public uint layer_or_depth_plane;
		public SdlPixels.SDL_FColor clear_color;
	...
	public struct SDL_GPUBlitInfo
	{
		...
		public SDL_GPULoadOp load_op;
		public SdlPixels.SDL_FColor clear_color;
		public SdlSurface.SDL_FlipMode flip_mode;
	...
	[LibraryImport(NativeLibName)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial void SDL_SetGPUScissor(IntPtr render_pass, in SdlRect.SDL_Rect scissor);

	[LibraryImport(NativeLibName)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial void SDL_SetGPUBlendConstants(IntPtr render_pass, SdlPixels.SDL_FColor blend_constants);
